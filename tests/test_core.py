...
from coma.providers import Gmail, Microsoft
...
class TextTests(unittest.TestCase):
    def test_html_and_quoted_history_are_excluded(self):
        content = "<p>La reunión será el jueves a las diez.</p><script>alert('x')</script><p>Trae el informe.</p><p>On Tue wrote:</p><p>texto antiguo</p>"
